      ...
      <section className="py-24">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold mb-8">Our Subscription Model</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Base Plan */}
            <div className="border border-gray-200 rounded-lg overflow-hidden transition-transform hover:transform hover:scale-105">
              <div className="p-8">
                ...
                <a href="mailto:contact@valyriastudios.com" className="block w-full py-3 text-center bg-black text-white rounded-md hover:bg-gray-800 transition-colors">
                  Contact Us
                </a>
              </div>
            </div>
            ...
            {/* Premium Plan */}
            <div className="border-2 border-black rounded-lg overflow-hidden shadow-lg transition-transform hover:transform hover:scale-105 relative">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">Continuous Iteration</h3>
              <p className="text-gray-600">
      ...
      <section className="py-24">
        <div className="container-custom max-w-4xl">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-3">Who will be working on my project?</h3>
              <p className="text-gray-600">
